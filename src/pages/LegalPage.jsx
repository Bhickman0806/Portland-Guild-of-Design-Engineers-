      ...
      <main className="page-main">
        <section className="policy-hero">
          <div className="policy-hero__inner">
            <h1 className="policy-title" id="legal">{data?.pageTitle || "LEGAL"}</h1>
            <p className="policy-subtitle">{data?.lastUpdated || "Open source acknowledgments and copyright notice."}</p>
          </div>
        </section>
