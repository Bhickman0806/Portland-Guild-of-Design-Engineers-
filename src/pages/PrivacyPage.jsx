...
export const PrivacyPage = () => {
  ...
  useEffect(() => {
    client.fetch(`*[_type == "privacyPage"][0]`)
      ...
      <main className="page-main">
        <section className="policy-hero">
          <div className="policy-hero__inner">
            <h1 className="policy-title" id="privacy-policy">{data?.pageTitle || "PRIVACY POLICY"}</h1>
            <p className="policy-subtitle">{data?.lastUpdated || "How we handle your information."}</p>
          </div>
        </section>
